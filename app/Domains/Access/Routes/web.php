...
$this->group(['prefix' => 'dashboard','middleware' => ['permission:ver-administracao']],function (){
    ...
    $this->group(['prefix' => 'roles'], function (){
        ...
        $this->get('/create','RoleController@create')->middleware('permission:criar-peril')->name('admin.roles.create');
        $this->post('/','RoleController@store')->middleware('permission:criar-peril')->name('admin.roles.store');
